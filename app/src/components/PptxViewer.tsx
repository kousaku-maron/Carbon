...
export function PptxViewer(props: PptxViewerProps) {
  ...
  return (
    <div className="pptx-viewer">
      <header className="pptx-viewer-header">
        <span className="pptx-viewer-title">{file.name}</span>
        <button
          type="button"
      ...
      <div className="pptx-viewer-content">
        <PptxDeck sourcePath={file.path} title={file.name} />
      </div>
